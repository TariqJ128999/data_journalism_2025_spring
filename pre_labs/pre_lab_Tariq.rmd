...
```{r}
head(umd_courses)
nameOfClass(umd_courses)
```

In the space below, write the name of the business from the first row of the "name" column. **Directed Research**
...
**I think this code is used to sepereate and group the amount of courses each semester**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Compared to the previous codeblock this one is arranged desecending from greatest to least for the count_classes**
...
**We can now see the name of the course based on the department**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **We can now see the total seats compared to the other codeblocks we could not**
...
**This database now includes sum, mean, and median of seats. Also it added a minimum and maximum number of seats**
...
1.  One question I have about this database is why the total seats is so high?

2.  Is this data updated and active to the actual numbers at the university of Marylnad?
